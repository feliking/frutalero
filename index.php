                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="ca-navbar">
                                <ul class="navbar-nav ml-auto" id="nav">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="#features">Productos</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#screenshot">Promoción</a></li>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-md">
                    <div class="wellcome-heading">
                        ...
                        <h3 style="font-family: titulo">F</h3>
                        <p>Los mejores alimentos nutritivos a base de fruta</p>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    <div class="single-special text-center wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h4>Nuevas ideas</h4>
                        <p>Nosotros pensamos en nuevas formas de producir productos de consumo diario de alta calidad y nutrición para nuestros niños y población en general.</p>
                    </div>
                </div>
                <!-- Single Special Area -->
                <div class="col-12 col-md-4">
                    <div class="single-special text-center wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <p>Introducimos nuevos productos al mercado con un gran valor nutricional.</p>
                    </div>
                </div>
                <!-- Single Special Area -->
                <div class="col-12 col-md-4">
                    <div class="single-special text-center wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <p>Nosotros elaboramos nuestros productos con mucho amor y compromiso porque nos interesa la población y su alimentación diaria.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-xl-5 ml-xl-auto">
                        <div class="special_description_content">
                            <h2>Lo mejor de nosotros para ustedes</h2>
                            <p>Frutalero S.R.L nació de una idea entre ingenieros químicos de la Universidad Mayor de San Andrés que notaron que muchos que los productos que se consumen a diario en especial sobre el desayuno llevan químicos que son algo fuertes o peligrosos si se consumen constantemente.</p>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="footer-text">
                        <p>Envíanos tu opinión o sugerencias, estaremos atentos a tus comentarios</p>
                    </div>
                    <div class="address-text">
                        <p><span>Dirección:</span> Zona Ciudadela Ferroviaria, Calle 3, Nro. 1030</p>
                    </div>
                    <div class="phone-text">
                        <p><span>Teléfono:</span> 22 - 30 10 83</p>
                    </div>
                    <div class="email-text">
                        <p><span>Correo Electrónico:</span> abigail.estrada@frutalerosrl.org</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <!-- Form Start-->
                        ...
                        <form action="#" method="post">
                            ...
                            <div class="contact_input_area">
                                <div class="row">
                                    ...
                                    <!-- Single Input Area Start -->
                                    <div class="col-12">
                                        <button type="submit" class="btn submit-btn">Envíar ahora</button>
                                    </div>
                                </div>
                            </div>
