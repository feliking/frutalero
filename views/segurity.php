...
<head>
    ...
    <title>Frutalero S.R.L. - Seguridad</title>
    <!-- Bootstrap Core CSS -->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4">
                        ...
                        <div class="login-content card">
						  ...
						  <b>Información:</b> Por seguridad se cerró su sesión automaticamente por estar inactivo mucho tiempo
					  	</div>
                            <div class="login-form">
                                <h4>Ingrese sus datos nuevamente</h4>
