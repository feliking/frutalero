...
<body>
	<nav class="cd-stretchy-nav">
        ...
        <ul>
            ...
            <li><a href="../views/cumplidos.php"><span><font color="#E0D300">Ver requerimientos cumplidos</font></span></a></li>
  ...
  <table id="example" class="display table table-bordered table-hover" cellspacing="0" width="100%">
        <thead>
            <tr>
                ...
                <th>Fecha entrega requerimiento a RRHH</th>
        ...
        <tbody>
            ...
            while($arreglo=mysqli_fetch_array($query)){
              $add=true;
              $sql1=("SELECT * FROM proveedor where id_pro='$arreglo[14]'");
