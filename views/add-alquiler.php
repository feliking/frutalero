...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-primary">
          Registrar nuevo contrato de alquiler
        </h3>
    </div>
</div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-elements">
                                    <form name="crea_alquiler" method="post" action="../controller/add_alquiler.php" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="garantiabs" id="garantiabs" placeholder="Garantía en Bs">
                                                </div>
                                                <div class="form-group">
                                                    <label>Garantía $us</label><span class="text-danger">*</span>
                                                    <input type="text" class="form-control" name="garantiasus" id="garantiasus" placeholder="Garantía en $us">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                  <input type="submit" class="btn-rounded btn-info" value="Registrar contrato de alquiler">
                                                </div>
