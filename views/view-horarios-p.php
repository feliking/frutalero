...
<div class="container-fluid">
      ...
      <div class="row">
          <div class="col-12">
              <div class="card">
                  <div class="card-body">
                      <h4 class="card-title">Horarios asignados</h4>
                      <h6 class="card-subtitle">Esta lista muestra a los trabajadores y sus horarios respectivos</h6>
                      <div class="table-responsive m-t-40">
                        <table id="example23" class="display table table-hover table-striped table-bordered" cellspacing="0" width="100%">
						        ...
						        <?php
						            ...
						            $sql="SELECT p.carnet, p.nombres, p.apellidos, h.lunes, h.martes, h.miercoles, h.jueves, h.viernes, h.sabado, h.domingo, ha.id FROM horarios h, personal p, horarios_a ha WHERE h.id = ha.id_horario and p.id = ha.id_personal";
						            ...
						            while($arreglo=mysqli_fetch_array($query)){
						              ...
						              if ($_SESSION["tipo"]==0 || $_SESSION["tipo"]==1) {
						                echo "<td class='text-center'><a class='btn btn-link' href='#hor$count'><span class='fa fa-list'></span></a><a class='btn btn-link' href='../controller/delete_horario_a.php?id=$arreglo[10]'><span class='fa fa-trash'></span></a></td>";
						              }
