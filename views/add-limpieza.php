...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-primary">
          Registrar nuevo contrato de limpieza
        </h3>
    </div>
</div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-elements">
                                    <form name="crea_alquiler" method="post" action="../controller/add_limpieza.php" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="centro_focal" id="centro_focal" placeholder="Centro Focal">
                                                </div>
                                                <div class="form-group">
                                                    <label>Tipo de centro focal</label>
                                                    <input type="text" class="form-control" name="tipo_centro_focal" id="tipo_centro_focal" placeholder="Tipo del centro focal">
                                                </div>
                                                <div class="form-group">
                                                    <label>Nombre de la empresa</label><span class="text-danger">*</span>
                                                    <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre de la empresa" required>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="canon_mensual" id="canon_mensual" placeholder="Introduzca monto Ej. 2056.90" step="0.01">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                  <input type="submit" class="btn-rounded btn-info" value="Registrar contrato de limpieza">
                                                </div>
